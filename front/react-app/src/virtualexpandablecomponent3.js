...
import RadarChartExample from "./abilitygraph";



const VirtualExpandableComponent3 = ({jsondata}) =>  {
    ...
    return (
      <div>
        ...
        <span style={{ fontSize: '24px',}}>조상님의 스탯은?</span>
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
        ...
        <br></br>
        <br></br>
        {isExpanded && <RadarChartExample jsondata={jsondata}></RadarChartExample>}
        <br></br>
        <br></br>
        <br></br>
        <br></br>
  ...
  export default VirtualExpandableComponent3