        ...
        switch(name) {
            case "박세채(朴世采)": {
                lifesummary.setContents("박세채는 반남 박씨 가문에서 출생하여, 성균관에서 학문을 시작하였다. 그는 이이(李珥)의 학문에 깊은 존경심을 가지고 있었으며, 이후 학자이자 정치인으로서의 삶을 시작하였다.\n" +
                        ...
                        "\n" +
                        "마지막으로, 박세채는 학문적으로나 정치적으로 중요한 발자취를 남긴 인물로서, 후세에 큰 존경을 받고 있는 인물이다. 그의 삶은 신념과 학문, 그리고 불굴의 정신으로 가득 찬 조선 시대의 선비의 모습을 보여준다.test2");
        ...
        switch(name) {
            ...
            case "김상익(金尙翼)": {
                ...
                mbti.setContents("김상익의 기록을 통해 몇 가지 성격적 특성을 추측해 볼 수 있다.\n" +
                        ...
                        "T: 그는 자신의 의견을 명확하게 표현하고 국상과 관련된 문제에 대해 열정적으로 논의했습니다. 이는 공정하고도 냉철한 판단력을 가진 이성적인 사람을 보여준다.\n" +
            ...
            case "이산해(李山海)": {
                ...
                mbti.setContents("이산해의 기록을 통해 그의 성격에 대해 추측 할 수 있다.\n\n"+
                        ...
                        "\n" +
                        "이런 특성을 바탕으로 이산해의 MBTI 유형을 예측해보면 'ENTJ'(외향적, 직관적, 사고적, 판단적)로 볼 수 있습니다. ENTJ 유형은 '지도자' 혹은 '사령관'으로 불리며, 큰 그림을 보는 능력과 타인을 이끌어나가는 리더십 능력을 보유하고 있다. 이러한 유형은 이산해의 행동양식과 일치하는 경향이 있다.");
